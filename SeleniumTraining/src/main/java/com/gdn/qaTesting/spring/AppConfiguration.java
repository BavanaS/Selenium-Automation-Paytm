package com.gdn.qaTesting.spring;
...
@Configuration
@ComponentScan({ "com.gdn.qaTesting" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.gdn.qaTesting");
                servletContext.setInitParameter("tapestry.development-modules", "com.gdn.qaTesting.services.DevelopmentModule");
